...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col">
            ...
            <img src="" alt="">
            <p>Fill out the order form with your paper details and proceed to secure payment..</p>
        
        <img src="" alt="">
        <p>Log in to your personal area and see how your order is going..</p>
        <img src="" alt="">
        <p>When the paper is ready, find it in the control panel. Review it, approve or send for a changes.</p>
        </div>
    ...
    <h4> <em>Our Stats</em>
       ...
       <span class="text-center justify-content-center">______</span> 
    <div class="row mt-3"><div class="col border-end border-success border-bottom ">
...
<div class="container-fluid mt-5 pb-3" >
    ...
    <p class="pt-3">We guarantee high quality to our customers. Our writing services are competitively priced, offering the absolute best quality for the cheap price.</p></div>
        <div class="col border-end border-success text-center"> <h4 class="text-center text-success">24/7 Online Support</h4>
