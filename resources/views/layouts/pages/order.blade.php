...
<meta name="description" content="topessaytutors.com provides online assignment help for students. Our team of experts can help you with essays, online classes, exams, projects, and more. Get high grades and reduce stress with our affordable services. Contact us on WhatsApp today!" />
...
<div class="form-group row">
    ...
    <div class="col-md-3">
        <div class="input-group">
            ...
            <input type="number" required="required" min="0" name="pages" class="form-control border-info pageInput" id="pageInput" style="max-width: 80px;" oninput="">
            <span class="input-group-btn">
...
<div class="form-group row">
    ...
    <div class="col-md-5">
        <div class="input-group">
            ...
            <input type="number" required="required" min="0" name="sources" class="form-control border-info sources-input pageInput" style="max-width: 80px;" oninput="">
            <span class="input-group-btn">
...
<div class="form-group row">
    ...
    <div class="col-md-5">
        <div class="input-group">
            ...
            <input type="number" required="required" min="0" name="charts" class="form-control border-info sources-input pageInput" style="max-width: 80px;"  oninput="" required>
            <span class="input-group-btn">
                <button type="button" class="btn btn-outline-info incrementBtn" ><i class="fa fa-plus"></i></button>
            </span>
        </div>
...
<div class="form-group text-center">
    <input type="submit" value="Checkout" class="btn btn-primary text-white checkout">
</div>
        ...
        <div class="col-md-4">
            <div class="order_summary">
                ...
                <table class="table table-border-style summary_table">
                    <tbody>
                        <tr>
                            <td><span id="pagesCount">0</span> Pages X <span id="chargepage"></span></td>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        for (var i = 0; i < inputs.length; i++) {
            inputs[i].addEventListener('input', updateCost); // Update cost calculation
        }
        ...
        function updateCost() {
            ...
            var sourcesInput = document.querySelector('input[name="sources"]');
            var chartsInput = document.querySelector('input[name="charts"]');
            var slidesInput = document.querySelector('input[name="slides"]');
            var urgencyInput = document.querySelector('input[name="urgency_id"]:checked');
            var spacingInput = document.querySelector('input[name="spacing"]:checked');
            var academicLevelSelect = document.querySelector('select[name="academic_level"]');
            var selectedOption = academicLevelSelect.options[academicLevelSelect.selectedIndex];
           

            var pages = parseFloat(pagesInput ? pagesInput.value : 0);
            var sources = sourcesInput ? sourcesInput.value : 0;
            var charts = chartsInput ? chartsInput.value : 0;
            var slides = slidesInput ? slidesInput.value : 0;

            // Determine the charge per page based on academic level
            var chargePerPage = 0;
            
            if (selectedOption ) {
                var academicLevel = selectedOption.value;
                console.log(academicLevel);
                if (academicLevel === "Undergraduate") {
                    chargePerPage = 15;
                } else if (academicLevel === "Highschool") {
                    chargePerPage = 10;
                }
            }

            var pagesCost = pages * chargePerPage;
            console.log(pagesCost);
            ...
            var urgency = urgencyInput ? urgencyInput.value : null;
            var spacing = spacingInput ? spacingInput.value : null;
            ...
            document.getElementById('chargepage').textContent = chargePerPage;
        }
    });
</script>
