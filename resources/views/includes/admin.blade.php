        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li class="nav-item pt-4">
                        <a href="#" class="nav-link align-middle px-0 text-white" data-bs-toggle="collapse" data-bs-target="#coursesMenu" aria-expanded="false">
                            <i class="fas fa-book text-white"></i> <span class="ms-1 d-none d-sm-inline">Courses</span>
                            <i class="fas fa-chevron-down ms-2"></i>
                        </a>
                        <ul class="collapse nav flex-column ms-3" id="coursesMenu">
                            <li class="nav-item">
                                <a href="" class="nav-link text-white">
                                    <i class="fas fa-plus text-white"></i> Create New Course
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="" class="nav-link text-white">
                                    <i class="fas fa-list text-white"></i> View Courses
                                </a>
                            </li>
                    ...
                    <li class="nav-item pt-4">
                        <a href="#" class="nav-link align-middle px-0 text-white" data-bs-toggle="collapse" data-bs-target="#studentsMenu" aria-expanded="false">
                            <i class="fas fa-user-graduate text-white"></i> <span class="ms-1 d-none d-sm-inline">Students</span>
                            <i class="fas fa-chevron-down ms-2"></i>
                        </a>
                        <ul class="collapse nav flex-column ms-3" id="studentsMenu">
                            <li class="nav-item">
                                <a href="" class="nav-link text-white">
                                    <i class="fas fa-user-plus text-white"></i> Add New Student
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="" class="nav-link text-white">
                                    <i class="fas fa-users text-white"></i> View Students
                                </a>
                            </li>
                            <!-- Add more subcategories as needed -->
                        </ul>
