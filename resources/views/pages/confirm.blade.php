...
<form action="/confirm" method="post" id="passwordForm">
@csrf
    <h4 class="pt-2 fw-bold text-center">Confirm Code</h4>
    <div class="border border-black fw-black px-3 pt-3 pb-2 rounded shadow">


<div class="form-group mt-2">
<label for="password">Code</label>
<input type="text"  placeholder="Code"  class=" form-control " id='password' name="code" required> 
