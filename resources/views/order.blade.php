...
<div class="form-group row"><label class="col-md-2 control-label">Writer Category: </label> <div class="col-md-9"><div class="btn-group row"><button type="button" class="btn btn-outline-info writer_category_button active"><div class="writer_category_title"><strong class="category_name"> Standard
                                            <!----></strong></div> <div class="writer_category_body">
                                        Standard
                                    </div> <input type="radio" name="writer_category_id" value="1"></button><button type="button" class="btn btn-outline-info writer_category_button"><div class="writer_category_title"><strong class="category_name"> Silver
                                            <span>
                                                                    +20
                                                                        <span>%</span></span></strong></div> <div class="writer_category_body">
                                        Silver
                                    </div> <input type="radio" name="writer_category_id" value="2"></button><button type="button" class="btn btn-outline-info writer_category_button"><div class="writer_category_title"><strong class="category_name"> Gold
                                            <span>
                                                                    +30
                                                                        <span>%</span></span></strong></div> <div class="writer_category_body">
                                        Gold
                                    </div> <input type="radio" name="writer_category_id" value="3"></button><button type="button" class="btn btn-outline-info writer_category_button"><div class="writer_category_title"><strong class="category_name"> Platinum
                                            <span>
                                                                    +40
                                                                        <span>%</span></span></strong></div> <div class="writer_category_body">
                                        Platinum
                                    ...
                                    <div class="form-group row"><label class="col-md-2 control-label">Additional Features: </label> <div class="col-md-9"><div><input type="checkbox" name="feature_ids[]" class="form-check-input" value="1">Unlimited Revisions<br></div><div><input type="checkbox" name="feature_ids[]" class="form-check-input" value="2">Tip for Writer or Support Agent<br></div></div></div>
