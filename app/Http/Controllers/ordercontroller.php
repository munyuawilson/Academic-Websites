...
{   
    ...
    //save 
            $data = [
             ...
             //calculate the price
            $total_Price=0;
            $total_Price=$this->totalPrice($pages,$academicId,$charts,$slides,$urgencyId,$spacing);
          
    
            $order = Order::create([
                'academic_level' => $academicId,
                'paper_type' => $documentId,
                'subject_id' => $subjectId,
                'topic' => $topic,
                'instructions' => $request->get('instructions'),
        ...
        private function totalPrice($page,$academic_level,$charts,$slide,$urgency,$spacing){
            $total_price=0;
            $pagePrice=0;
